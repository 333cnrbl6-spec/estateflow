...
export const PRICING_TIERS = [
  {
    ...
    stripe_product: import.meta.env.VITE_STRIPE_LITE_PRODUCT,
    stripe_price_monthly: import.meta.env.VITE_STRIPE_LITE_MONTHLY,
    stripe_price_annual: import.meta.env.VITE_STRIPE_LITE_ANNUAL,
    recommended: false,
  },
  {
    id: 'starter',
    ...
    stripe_product: import.meta.env.VITE_STRIPE_STARTER_PRODUCT,
    stripe_price_monthly: import.meta.env.VITE_STRIPE_STARTER_MONTHLY,
    stripe_price_annual: import.meta.env.VITE_STRIPE_STARTER_ANNUAL,
    recommended: false,
  },
  {
    id: 'professional',
    ...
    stripe_product: import.meta.env.VITE_STRIPE_PROFESSIONAL_PRODUCT,
    stripe_price_monthly: import.meta.env.VITE_STRIPE_PROFESSIONAL_MONTHLY,
    stripe_price_annual: import.meta.env.VITE_STRIPE_PROFESSIONAL_ANNUAL,
    recommended: true,
  },
  {
    id: 'enterprise',
    ...
    excluded: [],
    stripe_product: import.meta.env.VITE_STRIPE_ENTERPRISE_PRODUCT,
    stripe_price_monthly: import.meta.env.VITE_STRIPE_ENTERPRISE_MONTHLY,
    stripe_price_annual: import.meta.env.VITE_STRIPE_ENTERPRISE_ANNUAL,
    recommended: false,
  },
];
