...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Top Header */}
      <header className={`fixed top-0 right-0 h-[72px] bg-card border-b border-border transition-all duration-300 ${sidebarCollapsed ? 'left-[68px]' : 'left-[260px]'} flex items-center justify-between px-6 z-40`}>
      ...
      <main className={`${sidebarCollapsed ? 'ml-[68px]' : 'ml-[260px]'} mt-[72px] min-h-screen transition-all duration-300`}>
        <Outlet />
      </main>
    </div>
  );
